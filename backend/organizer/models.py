...
class Events(models.Model):
    ...
    latitude = models.DecimalField(max_digits=50, decimal_places=40, null=True, blank=True)
    longitude = models.DecimalField(max_digits=50, decimal_places=40, null=True, blank=True)
