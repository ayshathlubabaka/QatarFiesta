...
function CategoryManage() {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      await fetch(
        `${baseURL}/api/v1/admin/category-change/${selectedItemId}/`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
  ...
  return (
    <div className="dashboard">
      ...
      {isCreateModalOpen && (
        <div className="modal">
          <div className="modal-content">
            <span className="close" onClick={() => setCreateModalOpen(false)}>
              &times;
            </span>
      ...
      {isDeleteModalOpen && (
        <div className="modal">
          <div className="modalContent">
            <span className="close" onClick={() => setDeleteModalOpen(false)}>
              &times;
            </span>
