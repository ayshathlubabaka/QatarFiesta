...
function Payment() {
  ...
  const { bookingId, eventId, selectedDate, numTickets, visitorNames, totalPrice, user } = bookingDetails;
        ...
        <form onSubmit={handleSubmit}>
          <div className="card">
            ...
            <div className="card-footer">
              <button type="submit" className="btn btn-dark">Checkout Using Stripe</button>
            </div>
          </div>
        </form>
        </div>
            ...
            {walletData ? (
              <div>
                ...
                { confirmModalOpen && (
                  ...
                  <button className='btn btn-primary' onClick={() => handleCheckoutConfirm()}>Confirm</button>
                </div>
                )}
              </div>
