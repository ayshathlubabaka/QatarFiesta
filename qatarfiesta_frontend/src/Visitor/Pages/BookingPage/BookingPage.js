...
function BookingPage() {
  ...
  return (
    ...
    <div className='container' style={{backgroundColor:"gray", marginTop:"100px", marginBottom:"100px"}}>
    <form onSubmit={handleSubmit} className="p-4 border border-secondary rounded">
        <div className="mb-3">
    ...
    >
       <option value="">Select a date</option>
        {eventData &&
            generateDateOptions(new Date(eventData.startDate), new Date(eventData.endDate)).map((formattedDate) => (
