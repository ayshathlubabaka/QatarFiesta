      ...
      <div className="row">
        ...
        >
          ...
          <div className="row bg bg-light m-2 p-3">
            ...
            <div className="col-6">
              <h4 style={{ fontWeight: "bolder" }}>CHAT</h4>
              <p>Time: 6am to 6 pm</p>
            </div>
            <div className="col-4">
              <button
                onClick={handleChat}
