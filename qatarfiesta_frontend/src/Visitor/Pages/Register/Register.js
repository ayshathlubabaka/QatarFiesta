...
function Register() {
  ...
  const submit = async(e) => {
    ...
    try {
    const response = await fetch('http://127.0.0.1:8000/api/v1/accounts/user/register/', {
      method: 'POST',
    ...
    <div>
       ...
       <div>
        ...
        <div className='signin_container'>
            <div className='signin_header'><h1>Register</h1></div>
            <div>
            <form onSubmit={submit}>
            <input type='text' className='signin_input' placeholder='Full Name' onChange={e => setName(e.target.value)}/>
