...
function ChatPage() {
  ...
  useEffect(() => {
    ...
    const getUserChatHistory = async (group_name='',page=1) => {
        try {
          const response = await fetch(`${baseURL}/api/chat/history/?group_name=${group_name}&page=${page}`)
...
{userId?
<div className='container-fluid, border border-dark col-md-8' style={{ maxWidth: '60%', margin:"50px" }} >
