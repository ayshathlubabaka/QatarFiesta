    ...
    <div className='col-md-3'>
      <div className="dropdown">
        ...
        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          <li><button className="dropdown-item" onClick={handleSort}>Descending</button></li>
          <li><button className="dropdown-item" onClick={handleSort}>Ascending</button></li>
        </ul>
      </div>
    </div>
    <div className='col-md-3'>
      <div className="dropdown">
        ...
        <ul className="dropdown-menu" aria-labelledby="filterDropdown">
          <li><button className="dropdown-item" onClick={() => handleFilter('all')}>All</button></li>
          <li><button className="dropdown-item" onClick={() => handleFilter('rejected')}>Not Approved</button></li>
          <li><button className="dropdown-item" onClick={() => handleFilter('approved')}>Approved</button></li>
        </ul>
      </div>
    </div>
  </div>
                ...
                <Table striped bordered hover responsive>
                  ...
                  <tbody>
                    {sortedData.map((item) => (
                      <tr key={item.id}>
                        <td>{item.id}</td>
                        <td onClick={() => handleViewEvent(item.id)} style={{ fontWeight: "bolder", cursor: "pointer" }}>{item.title}</td>
                        <td>{item.venue}</td>
